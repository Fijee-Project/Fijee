...
%
\newcommand{\PROBASPACE}{$(\Omega, \mathcal{A}, P)$}
\newcommand{\PROBASPACEF}{$(\Omega, \mathcal{F}, P)$}
\newcommand{\MARTINGALE}{$(X_{n},\mathcal{F}_{n})_{n \in \mathbb{N}}$}
\newcommand{\MC}{$(X_{n})_{n \in \mathbb{N}}$}
\newcommand{\MONTE}{Monte-Carlo}
...
\begin{center}
\textsc{\textbf{\LARGE Fijee:~Forward Inverse~/~Elextro-Encephalogram simulation}}
\end{center}
